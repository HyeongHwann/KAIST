...
rm(list = ls())
library(tidyverse)
setwd("C:/Users/Lenovo/hwan/quarto/") # in Thinkpad z16
# setwd("/Users/hwan/Desktop/KAIST") # in Macbook
nasdaq <- read_csv("투자분석_NDAQ.csv")
cme <- read_csv("투자분석_CME.csv")
ice <- read_csv("투자분석_ICE.csv")
rf <- read_csv("투자분석_sofrai.csv")
market <- read_csv("투자분석_snp500.csv")
...
```{r,output=FALSE}
financial <- read_csv("투자분석_financialstatement.csv")
```
